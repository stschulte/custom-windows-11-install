...
@ECHO Installing KB5037853 (this can take ~30 minutes)
...
:err_no_patch
@ECHO.
@ECHO Unable to find the installation file for KB5037853 in this directory.
...
@ECHO.
@ECHO Please download KB5037853 and store the MSU file in the same directory as
@ECHO build.bat
@ECHO.
@ECHO If you do not want to build the patch into the image, or you downloaded a
@ECHO more recent one than KB5037853 you will have to remove the check and commands
